...
| `commands/` | 93 个 canonical slash 命令(2026-09-03 实测;别名折叠进 canonical,不再单列) | builtin.ts 薄 barrel + cmd/group01-07(Round 29 拆分) |
...
- 挂起的设计决定:/schedule executor 三选一(轮询执行 / 收敛 control plane / 移除假入口)—— 已查实、待拍板,见 docs/OPEN-QUESTIONS.md OQ-1
