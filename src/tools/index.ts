...
export function createTools(
  ...
  return [
    ...
    lazy('EnterWorktree', 'Create and enter an isolated git worktree', { name: 'string', base_branch: 'string' }, ['name'],
      { mutatesState: true, concurrencySafe: false },
      () => new EnterWorktreeTool()),
    lazy('ExitWorktree', 'Exit and clean up a worktree', { name: 'string', action: 'string', delete_branch: 'boolean' }, [],
      { mutatesState: true, concurrencySafe: false },
